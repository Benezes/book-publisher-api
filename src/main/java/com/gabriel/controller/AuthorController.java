...
public class AuthorController {
	...
	public ResponseEntity<AuthorDTO> findAuthorByName(@PathVariable(value = "name") String name) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<AuthorDTO> updateAuthor(@PathVariable(value = "id") Long id, @RequestBody AuthorDTO dto) {
